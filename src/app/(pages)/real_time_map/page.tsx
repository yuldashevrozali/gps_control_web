...
const RealTimeMap: React.FC = () => {
  ...
  const startMarkerRef = useRef<LeafletMarker | null>(null); // 🔴 Boshlanish nuqtasi uchun
  ...
  // ✅ Agent tanlanganda marshrut va marker darhol chizilsin
  useEffect(() => {
  ...
  // Har 5 sekundda yangi nuqta tekshiruv
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      if (!lastPoint || lastPoint[0] !== newPoint[0] || lastPoint[1] !== newPoint[1]) {
        ...
        if (mapRef.current) {
          ...
          // ✅ Agar bu birinchi nuqta bo‘lsa, marker ham qo‘shiladi
